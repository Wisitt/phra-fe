...
const formSchema = z.object({
  ...
  ownedAmount: z.number().or(z.string().min(1, '*กรุณาระบุจำนวนที่มีผู้ครอบครอง')),
  maxSupply: z.number().or(z.string().min(1, '*กรุณาระบุจำนวนการผลิตทั้งหมด')),
  reserveDueDate: z.date().optional(),
  deliveryDate: z.date({
    message: '*กรุณาระบุวันที่ทำการจัดส่ง',
  }),
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="col-[2/-2] grid grid-cols-subgrid">
          <div className="col-span-3">
            <TypeNav currentType="new-booking" />
            <FormField
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>
                          จำนวนสินค้าที่มีผู้ครอบครอง
                        </FormLabel>
                        <FormControl>
                          <Input min={0} type="number" placeholder="กรุณาระบุจำนวนสินค้าที่มีผู้ครอบครอง" value={field.value} onChange={e => field.onChange(e.target.valueAsNumber)} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input min={0} type="number" placeholder="กรุณาระบุจำนวนการผลิตทั้งหมด" value={field.value} onChange={e => field.onChange(e.target.valueAsNumber)} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>วันที่ปิดรับคำสั่งซื้อ</FormLabel>
                        <FormControl>
                          <DatePicker placeholder="กรุณาระบุวันที่ปิดรับคำสั่งซื้อ" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>วันที่ทำการจัดส่ง</FormLabel>
                        <FormControl>
                          <DatePicker placeholder="กรุณาระบุวันที่ทำการจัดส่ง" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
