...
const formSchema = z.object({
  ...
  price: z.string().min(1, '*กรุณาระบุราคาของสินค้า'),
...
export default function RentReleaseForm() {
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="col-[2/-2] grid grid-cols-subgrid">
          <div className="col-span-3">
            <ProductTypeNav currentType="rent-sell" />
            <FormField
          ...
          <div className="col-span-6 col-start-5">
            ...
            <div className="mt-8 flex gap-4">
              <Button onClick={() => setIsConfirmDialogOpen(true)} className="w-[125px] rounded-full">
                เผยแพร่
              </Button>
