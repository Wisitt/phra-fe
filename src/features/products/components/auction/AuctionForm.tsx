...
const formSchema = z.object({
  ...
  note: z.string(),
  verificationImage: z.instanceof(File).refine(file => file.size < MAX_FILE_SIZE, {
    message: 'File size must be less than 4MB',
  }).nullable(),
  verificationAuthority: z.string(),
  verificationDate: z.date().nullable(),
  verificationCode: z.string(),
  startPrice: z.string().min(1, '*หากไม่ระบุจะทำการเปิดประมูลที่ราคา 0 บาท'),
  minBid: z.string().min(1, '*หากไม่ระบุผู้ซื้อสามารถเสนอราคาโดยไม่มีขั้นต่ำ'),
  minPrice: z.string().min(1, '*หากไม่ระบุเมื่อถึงเวลาที่กำหนดในการปิดประมูลจะทำการปิดประมูลให้ผู้ที่ทำการประมูลในราคาสูงสุดทันที'),
  showMinPrice: z.boolean(),
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="col-[2/-2] grid grid-cols-subgrid">
          <div className="col-span-3">
            <ProductTypeNav currentType="auction" />
            <FormField
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>ราคาประมูลเริ่มต้น</FormLabel>
                        <FormControl>
                          <Input
                            placeholder="กรุณาระบุราคาประมูลเริ่มต้น"
                            {...field}
                          />
                        </FormControl>
                        <FormMessage />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>ราคาประมูลขั้นต่ำต่อครั้ง</FormLabel>
                        <FormControl>
                          <Input
                            placeholder="กรุณาระบุราคาประมูลขั้นต่ำต่อครั้ง"
                            {...field}
                          />
                        </FormControl>
                        <FormMessage />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>ขั้นต่ำการปิดประมูล</FormLabel>
                      <div className="grid grid-cols-2 gap-4">
                        <FormControl>
                          <Input
                            placeholder="กรุณาระบุขั้นต่ำการปิดประมูล"
                            {...field}
                          />
                        </FormControl>
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem className="flex items-center gap-3 space-y-0">
                              ...
                              <FormLabel>
                                ต้องการให้แสดงราคาขั้นต่ำในการปิดประมูล
                              </FormLabel>
                              <FormMessage />
                            </FormItem>
                          )}
                ...
                <div className="grid grid-cols-2 gap-4">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>วันที่และเวลาทำการเปิดการประมูล</FormLabel>
                        <FormControl>
                          <DateTimePicker
                            placeholder="กรุณากรอกวันที่และเวลาทำการเปิดการประมูล"
                            {...field}
                          />
                        </FormControl>
                        <FormMessage />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>วันที่และเวลาทำการปิดการประมูล</FormLabel>
                        <FormControl>
                          <DateTimePicker
                            placeholder="กรุณากรอกวันที่และเวลาทำการปิดการประมูล"
                            {...field}
                          />
                        </FormControl>
                        <FormMessage />
