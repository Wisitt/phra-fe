  ...
  const information = [
    {
      ...
      title: 'ที่อยู่',
      description:
        '188/218 หมู่ 6 ถนนบางกรวย-ไทรน้อย ตำบลบางกรวย อำเภอบางกรวย จังหวัดนนทบุรี 11130',
    },
    {
      icon: PhoneIcon,
      title: 'โทร',
      description: '+66 87-7925399 (เวลาทำการ จันทร์ - ศุกร์ 8.30 - 18.00 น.)',
    },
    {
      icon: PrinterIcon,
      title: 'แฟกซ์',
      description: '+66 2254-9977',
    },
    {
      icon: MailIcon,
      title: 'อีเมล',
      description: 'devinnowavetect@devinnowave.co.th',
    },
  ]
    ...
    <div className="relative">
      <div className="relative z-10 space-y-8 text-white">
        ...
        <div className="space-y-8">
          <h2 className="text-lg font-bold">บริษัท เดฟ อินโนเวฟ เทค จำกัด</h2>
          ...
          <div className="flex gap-4">
            ...
            <Link href="#" target="_blank">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clipPath="url(#clip0_1705_144148)">
